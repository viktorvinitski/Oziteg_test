...
var navbarItem1 = document.querySelector('.navbar__item1');
var navbarItem2 = document.querySelector('.navbar__item2');

navbarItem1.onmouseover = function () {
  document.querySelector('.dropdown__menu').style.display = 'block';
  var dropItems = document.querySelector('.dropdown__menu-wrapper').children;

  var _iterator = _createForOfIteratorHelper(dropItems),
      _step;
...
navbarItem2.onmouseover = function () {
  ...
  var _iterator2 = _createForOfIteratorHelper(dropItems),
      _step2;
...
var burgerButton = document.querySelector('.navbar__burger');
var burgerClose = document.querySelector('.navbar__close');
...
var subAcc = document.getElementsByClassName("subAcc");
...
for (var _i = 0; _i < subAcc.length; _i++) {
  subAcc[_i].addEventListener("click", function () {
    this.classList.toggle("active");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14389" + '/');
...
//# sourceMappingURL=/test_oziteg.e31bb0bc.js.map